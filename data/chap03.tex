...
Similarly, the accuracy assessment obtained by TFSV-IT2FCM in Sanmenxia area showed { an overall classification accuracy of $90.42\%$  with the Kappa coefficient $0.8827$,} an increased nearly $7\%$ over the IV-FCM results.
...
\begin{table}[htbp]
    \caption{三门峡地区分类精度表}\label{tab:4}
    \centering
    \footnotesize
    \begin{tabular}{llll}
        \toprule
